O objetivo do exercício foi replicar o website encontrado no arquivo 'Desafio front academy 1.fig' a fim de colocar em prática os conhecimentos em HTML e CSS.

O site não foi construído com responsividade, portanto deve-se ajustar a resolução para 1366x768.
A maioria dos botões são funcionais, redirecionando a página para a designada para o button ou abrindo uma nava aba de navegação para ir ao site designado para não interferir na navegação do projeto.
